...
const RegisterScreen = ({ navigation }) => {
    ...
    const handleRegister = async () => {
        try {
            const response = await fetch('https://mp-hosted-backend.onrender.com/auth/register', {
                method: 'POST',
                headers: {
    ...
    return (
      ...
      />
            ...
            <View style={styles.buttonContainer}>
                <Button mode="contained" labelStyle={styles.buttonLabel} onPress={handleRegister} style={styles.button} >
                    Signup
                </Button>
            </View>
            <Text style={styles.signinLink} onPress={navigateToSignin}>Already have an account? Sign In</Text>
        </View>
    );
};
